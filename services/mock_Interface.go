...
func (m *MockBook) GetAllBooks(ctx context.Context, a, b string) ([]entities.Book, error) {
	m.ctrl.T.Helper()
...
func (mr *MockBookMockRecorder) GetAllBooks(ctx, a, b interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllBooks", reflect.TypeOf((*MockBook)(nil).GetAllBooks), ctx, a, b)
}
...
func (m *MockBook) PostBook(ctx context.Context, book entities.Book) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockBook) PutBook(ctx context.Context, book entities.Book, id int) (entities.Book, error) {
	m.ctrl.T.Helper()
...
func (mr *MockBookMockRecorder) PutBook(ctx, book, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PutBook", reflect.TypeOf((*MockBook)(nil).PutBook), ctx, book, id)
}
...
func (m *MockAuthor) PostAuthor(ctx context.Context, author entities.Author) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockAuthor) PutAuthor(ctx context.Context, author entities.Author, id int) (entities.Author, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAuthorMockRecorder) PutAuthor(ctx, author, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PutAuthor", reflect.TypeOf((*MockAuthor)(nil).PutAuthor), ctx, author, id)
}
